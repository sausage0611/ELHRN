...
sys.path.append('../../../../')
from trainers import trainer_second, elhrn_train
from datasets import dataloaders
from models.ELHRN import ELHRN
from utils import util

args = trainer_second.train_parser()
...
model_path = './2000_model_ResNet-12.pth'


pm = trainer_second.Path_Manager(fewshot_path=fewshot_path,args=args)



gpu = 0
torch.cuda.set_device(gpu)
autoparm_model = ELHRN(resnet=True)
autoparm_model.cuda()
...
auto_tm = trainer_second.Parm_Train_Auto_Manager(args,path_manager=pm,train_func=train_func)
