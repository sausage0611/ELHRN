...
from .eval_first import meta_test
sys.path.append('..')
...
def train_parser():
    ...
    parser.add_argument("--hard_lr", help="hard sample initial learning rate", type=float)
    parser.add_argument("--hard_gamma",help="hard sample learning rate cut scalar",type=float,default=0.1)
    ...
    parser.add_argument("--hard_epoch",help="number of epochs before lr is cut by gamma",type=int)
    parser.add_argument("--hard_stage",help="number lr stages",type=int)
...
class Path_Manager:
    ...
    def __init__(self,fewshot_path,args):
        ...
        self.val_select_pre = os.path.join(fewshot_path,'val_select_pre')
